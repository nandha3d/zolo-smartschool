import 'package:zolo_smart_school_staff/cubits/exam/offlineExamStudentResultsCubit.dart';
import 'package:zolo_smart_school_staff/cubits/exam/offlineExamsWithClassesAndSessionYearsCubit.dart';
...
import 'package:zolo_smart_school_staff/ui/screens/offlineResult/widgets/studentOfflineResultContainer.dart';
          ...
          if (state.studentResults.isEmpty) {
            return Center(
              child: noDataContainer(
                titleKey: noStudentResultsFoundKey,
              ),
            );
          }
          return Align(
            ...
            if (state is OfflineExamsWithClassesAndSessionYearsFetchSuccess) {
              if (state.offlineExams.isEmpty ||
                  context
                      ...
                      .getAllClasses()
                      .isEmpty) {
                return noDataContainer(titleKey: noOfflineExamFoundKey);
              }
