...
import 'package:zolo_smart_school_staff/cubits/teacherAcademics/assignment/createAssignmentCubit.dart';
import 'package:zolo_smart_school_staff/cubits/teacherAcademics/assignment/editAssignmentCubit.dart';
...
import 'package:zolo_smart_school_staff/ui/screens/teacherAcademics/widgets/customFileContainer.dart';
...
import 'package:zolo_smart_school_staff/ui/widgets/customCheckboxContainer.dart';
            ...
            ? BlocConsumer<EditAssignmentCubit, EditAssignmentState>(
                listener: (context, state) {
                  ...
                  if (state is EditAssignmentSuccess) {
                    ...
                    print("this is the error message ${state.errorMessage}");
                    Utils.showSnackBar(
