...
import 'package:zolo_smart_school_staff/cubits/teacherAcademics/assignmentSubmissions/assignmentSubmissionsCubit.dart';
...
import 'package:zolo_smart_school_staff/ui/widgets/customImageWidget.dart';
              ...
              Expanded(
                child: CustomTitleDescriptionContainer(
                  ...
                  description: Utils.formatDateAndTime(
                    Utils.parseDateSafely(assignmentSubmission.createdAt) ?? DateTime.now(),
                  ),
                ),
              ),
