...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These were previously read with env() from inside controllers, middleware
    | and views. Once config:cache runs, .env is not loaded and every one of
    | those calls returns null, so they belong here instead.
    |
    */

    'demo_mode' => (bool) env('DEMO_MODE', false),

    'applang' => env('APPLANG', 'en'),
