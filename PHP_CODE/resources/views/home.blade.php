...
@section('content')
        ...
        <div class="container">
            <div class="navbarWrapper">
                ...
                <div class="loginBtnsWrapper">
                    ...
                    {{-- Self-service trial signup removed: schools are created by the administrator. --}}
                </div>
            </div>
    ...
    <div class="main">
        ...
        <section class="heroSection" id="home">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="flex_column_start">
                                    <span class="commonTitle">{{ $settings['system_name'] ?? 'Zolo Schools' }}</span>
            ...
            {{-- registration_form include removed with the self-service signup. --}}
                                            ...
                                            <div class="swiperDataWrapper flex items-stretch h-full">
                                                <div class="pricingBox premium flex flex-col justify-between h-full">
                                                    <div class="startUpWrapper flex flex-col h-full">
                                                        ...
                                                        <button class="pricingBtn redirect-login">{{ __('login') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        @else
