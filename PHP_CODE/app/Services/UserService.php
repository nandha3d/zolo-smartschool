...
class UserService {
     ...
     *
     * This used to return the guardian's mobile number verbatim. The arguments are
     * kept so the existing call sites - one of which passes two - still work, but they
     * are deliberately ignored: an initial password must not be derivable from data
     * the school publishes or already holds.
     *
     * @return string
     */
     ...
     * Returns a generated password.
     *
     * This used to return the student's date of birth as ddmmyyyy, which is neither
     * secret nor hard to guess for a child at a known school.
     *
     * @return string
     */
