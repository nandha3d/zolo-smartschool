...
class WizardSettings
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        try {
            ...
            // Previously this flushed the system settings cache on every single request
            // for every Super Admin, then immediately refetched it - the cache did
            // negative work for that role. The wizard flags are invalidated where they
            // are written (WizardSettingsController), so reading through cache is safe.
