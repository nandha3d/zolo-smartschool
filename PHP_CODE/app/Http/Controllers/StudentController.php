...
class StudentController extends Controller
{
    ...
    public function resetPasswordUpdate(Request $request)
    {
        ...
        try {
            DB::beginTransaction();
            // Was the student's date of birth as ddmmyyyy - not a secret, and guessable
            // for a child at a known school. The generated password is returned once so
            // the administrator can pass it on, and must_change_password holds the
            // account at the change-password screen until the student replaces it.
            $generated = PasswordService::generate();
            ...
            ResponseService::successResponse('Data Updated Successfully', null, [
