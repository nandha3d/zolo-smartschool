...
class DriverHelperController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        // $order is interpolated into orderByRaw() below, so only the two valid
        // directions are accepted - anything else is discarded, not passed through.
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->reset_password) {
                $data['password'] = Hash::make(PasswordService::generate());
            }
