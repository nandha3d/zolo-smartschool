...
class SchoolController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // If only two parts (e.g., example.com) → return only first
        if (count($parts) == 2) {
            $host = $parts[0];
        }
        // If more than two parts (e.g., subdomain.example.com)
        else {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'school_image' => 'required|mimes:jpg,jpeg,png|max:2048',
        ...
        try {
            ...
            $database_name = 'zolo_schools_' . $schoolData->id . '_' . strtolower(strtok($school_name, " "));
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'edit_school_image' => 'nullable|mimes:jpg,jpeg,png|max:2048',
            'edit_domain' => [
                'nullable',
    ...
    public function sendCustomEmail($school_id, $data, $subject)
    {
        try {
            ...
            $placeholders = [
                ...
                '{system_name}' => $systemSettings['system_name'] ?? 'Zolo Schools',
    ...
    private function replaceInquiryEmailPlaceholders($request, $settings)
    {
        ...
        $placeholders = [
            '{system_name}' => $settings['system_name'] ?? 'Zolo Schools Support Team',
            '{school_name}' => $request->school_name,
