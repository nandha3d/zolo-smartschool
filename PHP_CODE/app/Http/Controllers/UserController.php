...
class UserController extends Controller
{
    ...
    {
        ResponseService::noAnyPermissionThenRedirect(['student-list', 'teacher-list', 'staff-list']);
    ...
    public function show() {
        ResponseService::noAnyPermissionThenSendJson(['student-list', 'teacher-list', 'staff-list']);
    ...
    {
        ResponseService::noAnyPermissionThenSendJson(['student-edit', 'teacher-edit', 'staff-edit']);
        $request->validate([
