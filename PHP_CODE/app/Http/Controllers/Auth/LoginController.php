...
class LoginController extends Controller
{
    ...
    */
    ...
    /**
     * Lockout thresholds for ThrottlesLogins, which AuthenticatesUsers pulls in.
     * This login() overrides the trait's own method, so the throttle has to be
     * driven explicitly below - without it password guessing was unlimited.
     */
    ...
    public function login(Request $request)
    {
        ...
        // Every failing path falls through to here, so this is where the attempt is
        // counted against the throttle key (login field + IP).
    ...
    private function generate2FACode($length = 6)
    {
        ...
        // random_int(), not rand(): this is an authentication code, and rand() is a
        // predictable PRNG that an attacker who sees a few codes can extrapolate from.
        for ($i = 0; $i < $length; $i++) {
