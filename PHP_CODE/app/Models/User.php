...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected static function boot()
    {
        ...
        // Accounts are created with a generated password that whoever created the
        // account relays to its holder. Defaulting this flag on every creation path -
        // controllers, services and the bulk importers alike - means that relayed
        // secret is only ever good for one sign in. A caller that has a reason to skip
        // the prompt can still set the attribute explicitly.
