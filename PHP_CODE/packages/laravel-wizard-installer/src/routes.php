...
Route::group([
    ...
    Route::post('/database', ['as' => 'install.database.store', 'uses' => InstallSetDatabaseController::class]);
    Route::get('/migrations', ['as' => 'install.migrations', 'uses' => InstallMigrationsController::class]);
    Route::post('/migrations', ['as' => 'install.migrations.store', 'uses' => InstallSetMigrationsController::class]);
    Route::get('/keys', ['as' => 'install.keys', 'uses' => InstallKeysController::class]);
    Route::post('/keys', ['as' => 'install.keys.store', 'uses' => InstallSetKeysController::class]);
