...
// The public subscription/cron-job route was removed. It was unauthenticated and ran
// Artisan::call('schedule:run'), so anyone could drive the daily billing cron at will.
// Run the scheduler from system cron instead:
...
// The install/* routes 404 once storage/installed exists.
// Installer routes. They 404 once storage/installed exists.
Route::group(['prefix' => 'install', 'middleware' => 'installer'], static function () {
    Route::get('php-function', [InstallerController::class, 'phpFunctionIndex'])->name('install.php-function.index');
});

// auth
Route::group(['middleware' => ['Role', 'checkSchoolStatus', 'status','SwitchDatabase','verifiedEmail','CheckForMaintenanceMode','2fa','mustChangePassword','wizardSettings']], static function () {
    ...
    Route::group(['middleware' => 'language'], static function () {
        ...
        Route::resource('addons', AddonController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('subscriptions', SubscriptionController::class)->only(['index', 'store', 'show', 'destroy']);
        ...
        Route::resource('staff', StaffController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        // driver helper
        Route::resource('driver-helper', DriverHelperController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('mediums', MediumController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('section', SectionController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('class', ClassSchoolController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('class-section', ClassSectionController::class)->only(['index', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('teachers', TeacherController::class)->only(['index', 'store', 'show', 'edit', 'update']);


        /*** Parents ***/
        Route::get('/guardian/search', [GuardianController::class, 'search']);
        Route::resource('guardian', GuardianController::class)->only(['index', 'store', 'show', 'update']);
        ...
        Route::resource('students', StudentController::class)->only(['index', 'create', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('timetable', TimetableController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('staff-attendance', StaffAttendanceController::class)->only(['index', 'store', 'show']);
        ...
        Route::resource('lesson', LessonController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('lesson-topic', LessonTopicController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('announcement', AnnouncementController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('assignment', AssignmentController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);

        /*** Sliders ***/
        Route::resource('sliders', SliderController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('session-year', SessionYearController::class)->only(['index', 'store', 'show', 'update', 'destroy']);


        /*** Exams ***/

        // Grades
        Route::resource('exam/grade', GradeController::class, ['as' => 'exam'])->only(['index', 'store', 'destroy']);

        // TODO : Improve this
        // Exam Timetables
        Route::resource('exam/timetable', ExamTimetableController::class, ['as' => 'exam'])->only(['index', 'edit', 'update', 'destroy']);
        ...
        Route::resource('exams', ExamController::class)->only(['index', 'store', 'show', 'update', 'destroy']);

        // TODO make two groups promote student and transfer student and classify the routes related to their group
        Route::resource('promote-student', PromoteStudentController::class)->only(['index', 'store', 'show']);
        ...
        Route::resource('language', LanguageController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('fees-type', FeesTypeController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('fees', FeesController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('online-exam', OnlineExamController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('online-exam-question', OnlineExamQuestionController::class)->only(['index', 'store', 'show', 'edit', 'update', 'destroy']);
        ...
        Route::resource('form-fields', FormFieldsController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('expense', ExpenseController::class)->only(['index', 'create', 'store', 'show', 'update', 'destroy']);
        // Payroll
        ...
        Route::resource('leave', LeaveController::class)->only(['index', 'create', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('semester', SemesterController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('stream', StreamController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        Route::resource('shift', ShiftController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
        ...
        // The related-data routes were removed along with their handlers: the table
        // name came from the URL, so DELETE related-data/delete/users/1 removed any
        // row in any table with no permission check.
        ...
        Route::group(['prefix' => 'reports/exam'], static function () {
            ...
            // Yearly Results
            // One route with an optional id, rather than two sharing a name. The
            // duplicate name made route:cache fail, so the application could not be
            // route-cached at all.
    ...
    // show and destroy are declared explicitly above, at vehicles/show and
    // vehicles/{id}/deleted. Leaving them in the resource registered a second route
    // under each of those names, which made route:cache fail.
    Route::resource('vehicles', VehicleController::class)->only(['index', 'store', 'edit', 'update']);
    ...
    Route::resource('route-vehicle', RouteVehicleController::class)->only(['index', 'store', 'show', 'update', 'destroy']);
    ...
    Route::prefix('transportation-requests')->name('transportation-requests.')->group(function () {
        ...
        Route::resource('/', TransportationRequestController::class)->parameters(['' => 'transportation_request'])->only(['index', 'show', 'update']);
    });


    Route::resource('transportation-expense', TransportationExpenseController::class)->only(['index', 'store', 'show', 'update']);
...
// Payment gateway return URL. Declared once, in the payment prefix group above -
// this was a second registration of the same URI under the same name.
