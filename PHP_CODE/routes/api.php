...
Route::group(['middleware' => ['APISwitchDatabase', 'auth:sanctum']], static function () {
    Route::post('logout', [ApiController::class, 'logout']);
...
Route::group(['prefix' => 'student'], static function () {
    ...
    //Authenticated APIs
    Route::group(['middleware' => ['APISwitchDatabase', 'auth:sanctum', 'checkSchoolStatus']], static function () {
...
Route::group(['prefix' => 'parent'], static function () {
    ...
    // Route::group(['middleware' => ['APISwitchDatabase', 'auth:sanctum']], static function () {
        ...
        Route::group(['middleware' => ['APISwitchDatabase', 'auth:sanctum']], static function () {
            ...
            Route::group(['middleware' => ['APISwitchDatabase', 'auth:sanctum', 'checkChild']], static function () {
